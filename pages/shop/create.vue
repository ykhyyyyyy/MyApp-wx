<template>
  <view class="container">
    <custom-nav-bar title="发布探店" :show-back="true"></custom-nav-bar>
    <view class="form-box">
...
export default {
  ...
  data() { return { title:'', content:'', imgs:[], userId:1, shopId:1 }; },
  methods: {
    ...mapActions('shopReview', ['createReview']),
    chooseImage() {
    ...
    async submit() {
      ...
      await this.createReview({shopId:this.shopId,userId:this.userId,title:this.title,content:this.content,imgs:this.imgs});
